package com.example.a1.huangshuai20190308.entity;
...
public class UserShow {
    ...
    public static class DataBean {
        ...
        public static class ListBean {
            ...
            public boolean productcheckbox;

            public boolean isProductcheckbox() {
                return productcheckbox;
            }

            public void setProductcheckbox(boolean productcheckbox) {
                this.productcheckbox = productcheckbox;
            }

            public ListBean(boolean productcheckbox) {
                this.productcheckbox = productcheckbox;
            }
